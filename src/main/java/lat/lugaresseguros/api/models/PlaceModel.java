...
public class PlaceModel {
	...
	public PlaceModel(Long id, String name, String description, String address_state, String address_city,
			String address_colonia, String address_street, String address_zipcode) {
		super();
		this.id = id;
		this.name = name;
